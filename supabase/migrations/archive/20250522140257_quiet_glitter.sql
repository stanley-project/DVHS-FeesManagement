/*
  ...
  1. New Tables
    - academic_year_transitions: Tracks the transition process between academic years
    - student_promotion_history: Records student promotion details
    - academic_year_settings: Stores academic year-specific settings

  2. Changes
    - Added new columns to academic_years table for transition tracking
