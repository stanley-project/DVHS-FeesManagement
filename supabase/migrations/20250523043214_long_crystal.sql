/*
  ...
  1. New Tables
    - `archived_students`: Stores graduated/inactive student records
    - `archived_fee_payments`: Stores old fee payment records
    - `archived_student_academic_history`: Stores old academic history
    
  2. Functions
    - `archive_old_data()`: Main archiving function
    - `cleanup_archived_data()`: Removes archived data from main tables
