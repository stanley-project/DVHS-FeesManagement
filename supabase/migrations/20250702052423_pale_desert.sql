...
BEGIN
  ...
  -- Get student details including bus_start_date, has_school_bus, and village_id
  SELECT * INTO v_student_record
  FROM students
  WHERE id = v_student_id;
  
  v_bus_start_date := v_student_record.bus_start_date;
  v_has_school_bus := v_student_record.has_school_bus;
  v_village_id := v_student_record.village_id;
