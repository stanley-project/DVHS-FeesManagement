...
import { Plus, Upload, Download, Filter, Eye, Pencil, ToggleLeft, Trash2, ArrowUpDown, RefreshCw } from 'lucide-react';
...
const StudentTable = ({ onAddStudent, onEditStudent, onViewStudent }: StudentTableProps) => {
  ...
  return (
    <ErrorBoundary onError={(error) => {
      console.error('StudentTable error:', error);
      handleApiError(error, handleRetry);
      return true;
    }}>
